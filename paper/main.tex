...
publisher straddling two folds stays two measurements. Every class carries its
articles' variance, banded by the error we measured ($4\%$ below $0.25$,
$64$--$82\%$ above $1$).
...
5--7\,s end to end. Opening a \emph{publisher} shows one class per model with its
variance band and charts; switching the rule, or unticking articles,
recomputes it live, exposing the verdict's sensitivity to each choice. We close
